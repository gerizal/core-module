...
class ConfigureDatabase implements SetupScript
{
    ...
    public function fire(Command $command)
    {
        ...
        while (! $connected) {
            ...
            if ($this->databaseConnectionIsValid($name, $user, $password, $host)) {
                $connected = true;
            }
    ...
    {
        $databasePassword = $this->command->secret('Enter your database password (leave <none> for no password)');
     ...
     * @return bool
     */
    protected function databaseConnectionIsValid($name, $user, $password, $host)
    {
        try {
